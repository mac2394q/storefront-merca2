                ...
                <div class="page-header__container container">
                    <div class="page-header__breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="<?php echo "dashboard.php?id=".$_GET['id']; ?>">Panel Principal</a>
                        ...
                        <div class="col-12 col-lg-3 d-flex">
                            <div class="account-nav flex-grow-1">
                                ...
                                <ul>
                                    ...
                                    <li class="account-nav__item"><a href="<?php echo "historicoMensual.php?id=".$_GET['id']; ?>">Historico Mensual</a></li>
                                    <li class="account-nav__item"><a href="<?php echo "historial.php?id=".$_GET['id']; ?>">Red de Asociados</a></li>
                                    <li class="account-nav__item"><a href="<?php echo "#?id=".$_GET['id']; ?>">Modelo de compensacion</a></li>
                                    <li class="account-nav__item"><a href="<?php echo "#?id=".$_GET['id']; ?>">Historico de puntos</a></li>
                                    <li class="account-nav__item"><a href="<?php echo "#?id=".$_GET['id']; ?>">Liquidacion de comision</a></li>
                                </ul>
                            </div>
                        </div>
